...
Fig. \ref{fig01:hclust} \xxx{confirms} the above stated polynomial time complexity of the implementation. Moreover, \xxx{it halted} at a dataset size of 47K because the testing machine \footnote{Intel Core i9-8950HK, 32GB RAM} ran out of memory.
