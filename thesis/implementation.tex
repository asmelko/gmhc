...
To greatly utilize a CUDA-enabled GPU and achieve a great performance, a program code must be written with respect to the GPU architecture. These guidelines help us in this task:
