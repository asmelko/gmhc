...
TEST(para, small)
{
	...
	std::vector<pasgn_t> expected = { {6, 29}, { 10, 22 }, { 17, 31 }, { 11, 32 }, { 15, 21 }, { 1, 34 }, { 20, 33 }, { 16, 18 }, { 2, 36 }, { 8, 37 }, { 30, 41 }, { 27, 42 }, { 3, 39 }, { 0, 7 }, { 4, 14 }, { 35, 40 }, { 38, 43 }, { 9, 24 }, { 25, 48 }, { 5, 50 }, { 45, 51 }, { 23, 52 }, { 49, 53 }, { 13, 54 }, { 47, 55 }, { 46, 56 }, { 12, 57 }, { 44, 58 }, { 26, 59 }, { 28, 60 }, { 19, 61 } };
